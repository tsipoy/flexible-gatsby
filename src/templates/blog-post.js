            ...
            <div className="page-content">
              ...
              <div className="wrap-content">
                ...
                <div className="page-figma">
                  <a href={post.frontmatter.figma} target="_blank">
                    Figma
                  </a>
                </div>
                <div className="page-source-demo">
                  <button className="page-source">
                    <a href={post.frontmatter.source} target="_blank">
                      <span>Source</span>
                      <span>
                        <svg
